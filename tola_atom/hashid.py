...
print("\n")
def function():
    ask_usr = input("Do you want to crack the hashID? [Y/n] : ")
    if ask_usr == "Y" or ask_usr == "y":
    # pwd = subprocess.check_output("pwd")
    # pwd1 = pwd.decode("utf8")
    # sachin = "/cyanide-framework.sh"
    # pwd2 = pwd1.rstrip("\n")
        bashCommand = "clear;. ./cyanide-framework.sh;decoder_main"
        output = subprocess.call(['bash','-c', bashCommand])

    elif ask_usr=="N" or ask_usr == "n":
